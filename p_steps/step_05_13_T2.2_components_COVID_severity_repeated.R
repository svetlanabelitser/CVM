...
# 2 create copy of list_all_covid_notifications with date date_previous with itself and only keep records having no match or date >= date_previous - 60, name list_covid_episodes
# 3 use this list_covid_episodes as the list of unique covid episodes: link to each record all components needed to assess severity of that specific episode
...
#-------------------------------------
# add to list_all_covid_notifications positive results from covid test

...
D3_study_population <- D3_study_population[, .(person_id, sex, date_of_birth, start_lookback, study_entry_date,
                                               study_exit_date, date_vax1, date_vax2, date_vax3, age_at_study_entry,
                                               ...
                                               at_risk_at_date_vax_1, type_vax_1, type_vax_2, type_vax_3,
                                               study_entry_date_vax1, study_exit_date_vax1, study_entry_date_vax2,
                                               study_exit_date_vax2, study_entry_date_vax3, study_exit_date_vax3,
                                               fup_days, fup_no_vax, fup_vax1, fup_vax2, fup_vax3)]
...
D3_Vaccin_cohort <- D3_study_population[!is.na(date_vax1) & (is.na(date_vax2) | date_vax1 < date_vax2) &
                                          (is.na(date_vax3) | date_vax2 < date_vax3), ]
D3_Vaccin_cohort <- D3_Vaccin_cohort[, age_at_date_vax_2 := floor(time_length(correct_difftime(date_vax2, date_of_birth), "years"))]
D3_Vaccin_cohort <- D3_Vaccin_cohort[, age_at_date_vax_3 := floor(time_length(correct_difftime(date_vax3, date_of_birth), "years"))]
D3_Vaccin_cohort <- D3_Vaccin_cohort[, .(person_id, sex, date_of_birth, study_entry_date, study_exit_date, date_vax1,
                                         date_vax2, date_vax3, age_at_date_vax_1, ageband_at_date_vax_1, CV_at_date_vax_1,
                                         COVCANCER_at_date_vax_1, COVCOPD_at_date_vax_1, COVHIV_at_date_vax_1,
                                         COVCKD_at_date_vax_1, COVDIAB_at_date_vax_1, COVOBES_at_date_vax_1,
                                         COVSICKLE_at_date_vax_1, immunosuppressants_at_date_vax_1,
                                         at_risk_at_date_vax_1, age_at_date_vax_2, age_at_date_vax_3, type_vax_1, type_vax_2,
                                         type_vax_3, study_entry_date_vax1, study_exit_date_vax1, study_entry_date_vax2,
                                         study_exit_date_vax2, study_entry_date_vax3, study_exit_date_vax3, fup_vax1,
                                         fup_vax2, fup_vax3)]
...
D3_vaxweeks_vaccin_cohort <- D3_study_population[!is.na(date_vax1) & (is.na(date_vax2) | date_vax1 < date_vax2) &
                                                   (is.na(date_vax3) | date_vax2 < date_vax3), ]
D3_vaxweeks_vaccin_cohort <- D3_vaxweeks_vaccin_cohort[, .(person_id, sex, date_of_birth, study_entry_date,
...
cohort_to_vaxweeks <- D3_study_population[, .(person_id, sex, study_entry_date, study_exit_date, ageband_at_study_entry, date_of_birth,
                                              study_entry_date_vax1, study_exit_date_vax1, study_entry_date_vax2,
                                              study_exit_date_vax2, study_entry_date_vax3, study_exit_date_vax3,
                                              type_vax_1, type_vax_2, type_vax_3, fup_no_vax, fup_vax1,
                                              fup_vax2, fup_vax3, at_risk_at_study_entry)]
...
cols <- c("fup_no_vax", "fup_vax1", "fup_vax2", "fup_vax3")
cohort_to_vaxweeks <- cohort_to_vaxweeks[, (cols) := lapply(.SD, calc_precise_week), .SDcols = cols]

colA = c(paste("study_entry_date_vax", 1:3, sep = ""), "study_entry_date")
colB = c(paste("study_exit_date_vax", 1:3, sep = ""), "study_exit_date")
colC = c(paste("fup_vax", 1:3, sep = ""), "fup_no_vax")
colD = paste("type_vax", 1:3, sep = "_")
...
cohort_to_vaxweeks <- cohort_to_vaxweeks[, Dose := as.character(Dose)][Dose == "4", Dose := "0"]
vaxweeks <- copy(cohort_to_vaxweeks)
studyweeks <- copy(cohort_to_vaxweeks)
vaxweeks <- vaxweeks[Dose %in% c(1, 2, 3), ]
...
vaxweeks <- vaxweeks[, .(person_id, start_date_of_period, end_date_of_period, Dose, week, month, sex, type_vax, date_of_birth, ageband_at_study_entry)]

vaxweeks_including_not_vaccinated <- copy(vaxweeks)[, month := NULL]

vaxweeks <- vaxweeks[, c("sex", "type_vax", "date_of_birth") := NULL]
...
D3_studyweeks_not_vaccinated <- D3_studyweeks_not_vaccinated[, .(person_id, study_entry_date, study_exit_date, Dose, fup, sex, type_vax, date_of_birth, ageband_at_study_entry)]

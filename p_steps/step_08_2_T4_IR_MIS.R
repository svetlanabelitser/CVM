...
for (subpop in subpopulations_non_empty) {  
  ...
  namedataset<-paste0("D4_persontime_b_BC",suffix[[subpop]])
...
#D4_persontime c----------------------------------------------
  ...
  namedataset<-paste0("D4_persontime_c_BC",suffix[[subpop]])
...
namedataset<-paste0("D4_persontime_d_BC",suffix[[subpop]])
load(paste0(diroutput,"D4_persontime_d_BC",suffix[[subpop]],".RData"))

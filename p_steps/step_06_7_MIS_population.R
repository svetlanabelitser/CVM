...
for (subpop in subpopulations_non_empty) {
  ...
  D3_study_variables_for_MIS[,study_exit_date_MIS_b:=max(min(end_dic_2021,study_exit_date,covid_date-1, date_vax1-1,na.rm = T),
                                                         first_jan_2020),by="person_id"]
  ...
  D4_population_b<-D3_study_variables_for_MIS[,.(person_id,sex,date_of_birth, age_at_1_jan_2021,ageband_at_1_jan_2021,study_entry_date_MIS_b, cohort_entry_date_MIS_b, study_exit_date_MIS_b, fup_days)]
  ...
  D4_population_c_no_risk <- CreateFlowChart(
    dataset = D3_selection_criteria_c[,.(person_id,sex,date_of_birth, age_at_1_jan_2021,ageband_at_1_jan_2021,study_entry_date_MIS_c, cohort_entry_date_MIS_c, study_exit_date_MIS_c,not_in_cohort_c, fup_days, CV_at_date_vax_1, COVCANCER_at_date_vax_1, COVCOPD_at_date_vax_1,

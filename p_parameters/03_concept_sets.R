...
OUTCOMES_conceptssets <- c("COVID_narrow","COVID_possible","ARDS_narrow","ARDS_possible","HF_narrow","HF_possible","MYOCARD_narrow","MYOCARD_possible","CAD_narrow","CAD_possible")
